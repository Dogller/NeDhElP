...
public class Puzzle2 extends AppCompatActivity {
    ...
    private static void display(Context context){
        ...
        for(int i = 0; i < tileList.length; i ++){
            ...
            if (tileList[i].equals("0")){
                button.setBackgroundResource(R.drawable.tulips1);
            }
            else if (tileList[i].equals("1")){
                button.setBackgroundResource(R.drawable.tulips2);
            }
            else if (tileList[i].equals("2")){
                button.setBackgroundResource(R.drawable.tulips3);
            }
            else if (tileList[i].equals("3")){
                button.setBackgroundResource(R.drawable.tulips4);
            }
            else if (tileList[i].equals("4")){
                button.setBackgroundResource(R.drawable.tulips5);
            }
            else if (tileList[i].equals("5")){
                button.setBackgroundResource(R.drawable.tulips6);
            }
            else if (tileList[i].equals("6")){
                button.setBackgroundResource(R.drawable.tulips7);
            }
            else if (tileList[i].equals("7")){
                button.setBackgroundResource(R.drawable.tulips8);
            }
            else if (tileList[i].equals("8")){
                button.setBackgroundResource(R.drawable.tulips9);
            }
    ...
    private static void swap(Context context, int currentPosition, int swap) {
        ...
        if (isSolved()) {
            ...
            dbHelper.updateContact(currentid, 3);
            ...
            builder.setPositiveButton("Next Level", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    Intent intent = new Intent(mContext,Puzzle3.class);
